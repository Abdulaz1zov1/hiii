...
import PageStaticTwentyOne from './pages/page_21/page_21'
...
import PageStaticFourty from './pages/page_40/page_40'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/page/static/get/21" element={<PageStaticTwentyOne />} />
        ...
        <Route path="/page/static/get/40" element={<PageStaticFourty />} />
